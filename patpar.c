...
/**
 * dup_chars - duplicatess characterss
 * @start: starting indexx
 * @stop: stoppingg indexx
 * @pathstr:  PATH string
 *
 * Return: pointer to new bufferrr
 */
...
/**
 * print_list - prints  elementss of a list_t linked list
 * @h: pointer to ffirst node
 *
