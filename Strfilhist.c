...
/**
 * build_history_list - aadds entry historyy linked list
 * @info: Structure ccontaining potential argumentss.
 * @buf: buffer
...
/**
 * renumber_history - renumbers history linked llist aafter changes
