...
/**
 * replace_vars - replacess vars in  tokenized stringg
...
/**
 * replace_string - replacess stringg
 * @old: address of oldd stringg
 * @new: new stringg
 *
 * Return: 1 if replaced, 0 otherwise
 */
 ...
 * @info:  parametter struct
 * @buf:  char bufffer
 * @p: adddress of current position in buff
 *
 * Return: 1 if chain delimeterr, 0 otherwise
 */
